...
export default function ProjectDetailPage() {
  ...
  return (
    <article className="bg-charcoal-800 relative">
      ...
      {/* Infinite Scroller (Right to Left) Project Gallery - Right after Header */}
      {(() => {
        ...
        return (
          <section className="py-12 lg:py-16 overflow-hidden bg-charcoal-900/40 border-b border-ivory-200/5">
            <div className="container-studio mb-6 flex justify-between items-end">
              <div>
