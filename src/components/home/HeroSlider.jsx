      ...
      <div className="relative z-10 h-full flex flex-col">
        <div className="flex-1 flex items-end container-studio pb-24 lg:pb-32">
          <div className="w-full max-w-3xl">
            ...
            {/* Title — fixed min-h so location text stays at a consistent position across all slides */}
            <div className="overflow-hidden min-h-[72px] sm:min-h-[80px] md:min-h-[90px] lg:min-h-[108px]">
              <AnimatePresence mode="wait">
                <motion.h1
