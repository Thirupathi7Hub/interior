      ...
      <div className="container-studio">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 lg:pl-8">
            ...
            >
              Founded in 2020, Luxe Studio was born from a belief that exceptional design belongs in every space. We have grown into one of Tirunelveli's most trusted design teams, known for smart planning, beautiful execution, and client satisfaction.
            </motion.p>
